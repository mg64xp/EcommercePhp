...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="util/Css/adminlte.min.css"></head>
...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item" id="nav_login">
        <a class="nav-link"  href="views/login.php" role="button">
          <i class="far fa-user"></i> Iniciar Seción
        </a>
      </li>
      ...
      <li class="nav-item dropdown" id="nav_usuario">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img id="avatar_nav" src="" alt="" width="30" height="30" class="img-fluid img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="util/img/User.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light"> Nombre Tienda</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img id="avatar_menu"src="util/img/User.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
